...
public void generateInterveningFieldstest1(){
		...
		MoveDemands demand = new MoveDemands(3, 3,ColourDemand.NOT_CURRENT_COLOUR, MovedStatusDemand.NO_DEMAND); 
...
public void generateInterveningFieldstest2(){
		...
		MoveDemands demand_2 = new MoveDemands(3, 4,ColourDemand.NOT_CURRENT_COLOUR, MovedStatusDemand.NO_DEMAND); 
